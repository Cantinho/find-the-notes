...
public class RubberIndicator extends RelativeLayout {
    ...
    private static final int DEFAULT_SMALL_CIRCLE_COLOR = 0xFF000000;
    private static final int DEFAULT_LARGE_CIRCLE_COLOR = 0xFFFF9630;
    private static final int DEFAULT_OUTER_CIRCLE_COLOR = 0xFF000000;
    ...
    private static final int BEZIER_CURVE_ANCHOR_DISTANCE = 0;
